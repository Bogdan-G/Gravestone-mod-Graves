...
public class StatuesHall extends CatacombsBaseComponent {
    ...
    public boolean addComponentParts(World world, Random random) {
        ...
        this.fillWithBlocks(world, boundingBox, 0, 0, 0, 0, 0, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 3, 0, 0, 3, 0, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 7, 0, 0, 7, 0, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 0, 0, 10, 0, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 0, 5, 0, 0, 5, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 3, 5, 0, 3, 5, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 7, 5, 0, 7, 5, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 5, 0, 10, 5, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 0, 0, 9, 0, 0, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 0, 3, 9, 0, 3, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 0, 6, 9, 0, 6, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 0, 9, 9, 0, 9, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 0, 12, 9, 0, 12, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 0, 15, 9, 0, 15, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 0, 18, 9, 0, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 5, 0, 9, 5, 0, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 5, 3, 9, 5, 3, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 5, 6, 9, 5, 6, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 5, 9, 9, 5, 9, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 5, 12, 9, 5, 12, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 5, 15, 9, 5, 15, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 1, 5, 18, 9, 5, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);

        // nether wall
        this.fillWithBlocks(world, boundingBox, 0, 1, 0, 0, 4, 0, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 0, 1, 3, 0, 4, 3, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 0, 1, 6, 0, 4, 6, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 0, 1, 9, 0, 4, 9, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 0, 1, 12, 0, 4, 12, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 0, 1, 15, 0, 4, 15, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 0, 1, 18, 0, 4, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 1, 0, 10, 4, 0, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 1, 3, 10, 4, 3, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 1, 6, 10, 4, 6, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 1, 9, 10, 4, 9, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 1, 12, 10, 4, 12, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 1, 15, 10, 4, 15, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 10, 1, 18, 10, 4, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 3, 1, 0, 3, 4, 0, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 7, 1, 0, 7, 4, 0, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 3, 4, 0, 7, 4, 0, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 3, 1, 18, 3, 4, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 7, 1, 18, 7, 4, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
        this.fillWithBlocks(world, boundingBox, 3, 4, 18, 7, 4, 18, gravestone.core.GSBlock.nsb, gravestone.core.GSBlock.nsb, false);
